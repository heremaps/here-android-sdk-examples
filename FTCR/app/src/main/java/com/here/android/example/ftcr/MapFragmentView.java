...
public class MapFragmentView {
    ...
    private GeoCoordinate[] fake_route;
    ...
    public static final String DEFAULT_OVERLAY = "OVERLAYEXAMPLE3";
    ...
    private void createRoute() {
        ...
        makeRequest(fake_route, new Callback() {
            @Override
    ...
    private void calculateRoute() {
        ...
        FTCRRoutePlan routePlan = new FTCRRoutePlan(routePoints, DEFAULT_OVERLAY, routeOptions);
        if (m_routeTask != null) {
            m_routeTask.cancel();
        }
    ...
    private void addFakeRoute() {
        ...
        fakeRoutePolyLine.add(Arrays.asList(fake_route));
